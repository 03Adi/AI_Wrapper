...
const faqs = [
  {
    question: 'How does Arexa AI generate personalized resumes?',
    answer: 'Arexa AI uses advanced AI to analyze your background and the job description you provide. It then generates a customized resume that matches the specific requirements and keywords from the job posting, increasing your chances of getting past ATS systems.'
  },
  {
  ...
  {
    question: 'Can I use Arexa AI for multiple job applications?',
    answer: 'Absolutely! One of the main benefits of Arexa AI is the ability to generate multiple customized versions of your resume for different job applications. This significantly increases your chances of getting interviews.'
  },
  {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Everything you need to know about Arexa AI.
          </p>
        </div>
